...
namespace MOLPayXDKExample
{
    ...
    public class MOLPayActivity : Activity
    {
        ...
        private static WebView mpMainUI,
            mpMOLPayUI,
            mpBankUI;
        ...
        public class MPMOLPayUIWebChromeClient : WebChromeClient
        {
            ...
            {
                Console.WriteLine(
                    "MPMOLPayUIWebChromeClient onCreateWindow resultMsg = " + resultMsg
                );

                RelativeLayout container = (RelativeLayout)
                    molpayActivity.FindViewById(Resource.Id.MPContainer);
